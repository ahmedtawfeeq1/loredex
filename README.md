...
[![Desktop app](https://img.shields.io/badge/desktop-mac%20·%20win%20·%20linux-2ea043)](https://github.com/ahmedtawfeeq1/loredex-desktop/releases/latest)
...
| Install the native desktop app (mac/win/linux) | [Desktop app](#desktop-app) · [download](https://github.com/ahmedtawfeeq1/loredex-desktop/releases/latest) |
...
| **Desktop app** | Native mac/win/linux app: handoff board, atlas graph, contract timeline, live sync, in-app MCP | **[ahmedtawfeeq1/loredex-desktop](https://github.com/ahmedtawfeeq1/loredex-desktop)** |
...
Prefer a purpose-built native app over Obsidian? **[Loredex Desktop](https://github.com/ahmedtawfeeq1/loredex-desktop)** ships for **macOS, Windows, and Linux** — download an installer from the [latest release](https://github.com/ahmedtawfeeq1/loredex-desktop/releases/latest):
...
| [DESKTOP](docs/DESKTOP.md) | The native desktop app — install per OS, first run, every view, MCP wiring, and desktop-vs-Obsidian |
...
- [x] Desktop app — [loredex-desktop](https://github.com/ahmedtawfeeq1/loredex-desktop): mac/win/linux, handoff board, atlas, contracts, live sync
